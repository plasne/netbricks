...
namespace NetBricks
{
    public interface IConfig
    {
        ...
        /// </returns>
        Task<Dictionary<string, string>> LoadAsync(string[] filters, bool useFullyQualifiedName = false);
        ...
        Task ApplyAsync(string[] filters = null);
        ...
        Task<T> GetSecretAsync<T>(string key, Func<string, T> convert = null, bool ignore404 = false);
        ...
        /// <param name="key">The key of the secret to retrieve.</param>
        /// <param name="ignore404">A boolean indicating whether to ignore a 404 (not found) error. If true, the method will return the default value of T in case of a 404 error.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains the secret value converted to a string.</returns>
        Task<string> GetSecretAsync(string key, bool ignore404 = false);
        ...
        /// If null, the default conversion will be used (only applicable if T is string).
        /// </param>
        /// <returns>The configuration value converted to a string.</returns>
        ...
        /// </returns>
        bool TryGetFromCache<T>(string key, out T val);
        ...
        /// </remarks>
        Task<string> GetFromKeyVaultAsync(string posurl, bool ignore404 = false);
    }
}
